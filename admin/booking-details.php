...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Pencucian Mobil Baiman</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Detail Pesanan #<?php echo $_GET['bookingid'];?></h2>
					    <table id="table">
...
<?php if($result->adminRemark==''): ?>
	<tr>
		<td colspan="3">
	<button data-toggle="modal" data-target="#myModal" class="btn-primary btn">Pembayaran</button>
</td>
</tr>
<?php  else:?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Pembayaran<?php echo $_GET['bookingid'];?></h4>
        </div>
        <div class="modal-body">
<form method="post">   
  <p>
            <select name="txntype" required class="form-control">
                <option value="">MetodePembayaran</option>
