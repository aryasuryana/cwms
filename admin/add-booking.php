...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Daftar Pemesanan </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3>Pesan Pencucian Mobil Baiman</h3>
...
<?php } ?>
				...
				<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Nomor Tlp</label>
									<div class="col-sm-8">
										<input type="text" name="contactno" class="form-control" pattern="[0-9]{10}" title="10 numeric characters only" required placeholder="NomorTlp">
									</div>
								</div>


								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Tanggal Mencuci</label>
									<div class="col-sm-8">
				...
				<div class="form-group">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Pesan</label>
									<div class="col-sm-8">
			...
			<div class="col-sm-8 col-sm-offset-2">
				<button type="submit" name="book" class="btn-primary btn">Pesan</button>

				<button type="reset" class="btn-inverse btn">Batal</button>
			</div>
		</div>
