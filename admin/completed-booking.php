...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Pesanan Selesai</li>
            </ol>
					  ...
					  <h2>Pesanan Selesai</h2>
						...
						<thead>
						  <tr>
						   <th>Pesanan No.</th>
							<th>Nama</th>
							<th width="200">Daftar Paket</th>
							<th>Lokasi</th>
							<th>Tanggal&Waktu </th>
							<th width="200">Pesanan Masuk </th>
							<th>Detail </th>
...
<td><a href="booking-details.php?bid=<?php echo htmlentities($result->bid);?>&&bookingid=<?php echo htmlentities($result->bookingId);?>">Lihat</a>
</td>
<?php } ?>
</tr>
						 <?php } else { ?>
